<template> 
  <div class="relative" style="background-color: var(--primary-bg);">
      ...
      >      
        ...
        <ul class="anim-img-hover-links grid grid-cols-2 gap-8 justify-center items-center h-full max-w-screen-xl w-full px-4 mx-auto | md:grid-cols-3 md:gap-0">
          <li class="basis-4/12">
    ...
    <canvas id="anim-img-hover-canvas"></canvas>
  </div>
