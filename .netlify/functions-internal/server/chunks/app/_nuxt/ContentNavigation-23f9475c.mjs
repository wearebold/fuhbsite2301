...
import { a as useContentDisabled, u as useAsyncData, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify, c as createQuery } from './utils-d5e23ebc.mjs';
import { d as useState, b as useRuntimeConfig } from '../server.mjs';
import { y as hash, z as withLeadingSlash, j as joinURL, x as withoutTrailingSlash } from '../../nitro/netlify.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-83d13753.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-83d13753.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-23f9475c.mjs.map
