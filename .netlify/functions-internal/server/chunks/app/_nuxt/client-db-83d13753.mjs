...
import { a as createPipelineFetcher, c as createNav } from './navigation-98cc5949.mjs';
...
async function generateNavigation(query) {
  ...
  return createNav((contents == null ? void 0 : contents.result) || contents, configs);
}

export { contentStorage, createDB, generateNavigation, useContentDatabase };
//# sourceMappingURL=client-db-83d13753.mjs.map
