...
import { J as pascalCase, E as destr } from '../../nitro/netlify.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  render(ctx) {
    ...
    let component = tag || ((_a = meta.component) == null ? void 0 : _a.name) || meta.component || "div";
...
async function resolveContentComponents(body, meta) {
  ...
  await Promise.all(components.map(async (c) => {
    if ((c == null ? void 0 : c.render) || (c == null ? void 0 : c.ssrRender)) {
      return;
    }
  ...
  function loadComponents(node, documentMeta) {
    ...
    const renderTag = typeof ((_a = node.props) == null ? void 0 : _a.__ignoreMap) === "undefined" && documentMeta.tags[tag] || tag;
    const components2 = [];
...
//# sourceMappingURL=ContentRendererMarkdown-d83be199.mjs.map
