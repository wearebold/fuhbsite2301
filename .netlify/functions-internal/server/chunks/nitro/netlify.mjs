...
function hash$1(object, options = {}) {
...
const _assets = {
  ["nitro:bundled:cache:content:content-index.json"]: {
    ...
    meta: {"type":"application/json","etag":"\"124-Ic+GpucQOo14mkmswcbSKpL+3b0\"","mtime":"2023-08-31T12:14:36.265Z"}
  },
  ["nitro:bundled:cache:content:content-navigation.json"]: {
    import: () => import('../raw/content-navigation.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"1e9-DQuRBAUW2pV63dQc+KMcIduXJzo\"","mtime":"2023-08-31T12:14:36.265Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:journal:my-forst-post.md"]: {
    import: () => import('../raw/my-forst-post.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"3ad-UUcjITtyWts5wy61+MxyAcbo8gg\"","mtime":"2023-08-31T12:14:36.265Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:services:beauty:hd-brows.md"]: {
    import: () => import('../raw/hd-brows.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"756-puSzMisl4b17UJ6MsShVuNumZIQ\"","mtime":"2023-08-31T12:14:36.265Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:services:beauty:nails.json"]: {
    import: () => import('../raw/nails.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"2ad-xMdMMtEsdX436n36+3Sl7vSM69E\"","mtime":"2023-08-31T12:14:36.265Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:services:beauty:nails.md"]: {
    import: () => import('../raw/nails2.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"1374-/LqD1RlUjqsUYwLsEpFW1AWDumo\"","mtime":"2023-08-31T12:14:36.265Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:services:hair:hair-01.md"]: {
    import: () => import('../raw/hair-01.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"1c5-MzYKqeH7WWeO6uJ2aXSdshQRovA\"","mtime":"2023-08-31T12:14:36.265Z"}
  }
};
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/p10289359/Sites_wearebold/fuhbsite2301/.data/kv"}));
...
const _3lpm3J = eventHandler(async (event) => {
...
const highlight = {"theme":{"default":"material-palenight","dark":"github-dark"}};
...
function rehypeShiki(opts = {}) {
  ...
  return async (tree) => {
    ...
    visit(
      ...
      (node) => {
        const _node = node;
        const task = options.highlighter(toString$1(node), _node.properties.language, options.theme).then(({ tree: tree2, className, style }) => {
...
const parseMarkdown = async (md, opts = {}) => {
  const options = defu(opts, defaults$1);
...
const _sY1rlY = defineEventHandler(async (event) => {
...
const _Ocsfa1 = defineEventHandler(async (event) => {
...
const _628K1K = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_KpAjZF = () => import('../handlers/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_KpAjZF, lazy: true, middleware: false, method: undefined },
  { route: '/api/_mdc/highlight', handler: _3lpm3J, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _sY1rlY, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _sY1rlY, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _sY1rlY, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.1693484066026.json', handler: _Ocsfa1, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _628K1K, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _628K1K, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _628K1K, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_KpAjZF, lazy: true, middleware: false, method: undefined }
];
