        ...
        fontFamily: {
         ...
         extend: {
            ...
            fontSize: {
                ...
                'caps': 'clamp(0.625rem, 0.563rem + 0.31vw, 0.75rem)',
                'nav-header': 'clamp(1.5rem, 0.955rem + 2.73vw, 3rem)', // 1  
                'services': 'clamp(1.5rem, 0.955rem + 2.73vw, 3rem)'              
            },
            letterSpacing: {
                widest: '.25em',
            },
